...
// Initialize Firebase
// Unlike what is in the firebase doc, you need to check if the app is already initialized, if it isn't, you need to initialize it... All this is because you are using NExt.js SSR
